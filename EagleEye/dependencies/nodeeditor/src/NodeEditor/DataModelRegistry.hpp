...
namespace QtNodes
{
class NODE_EDITOR_PUBLIC DataModelConstructor
{
public:
    virtual ~DataModelConstructor(){}
    virtual QString name() const = 0;
    virtual std::unique_ptr<NodeDataModel> construct() const = 0;
};
...
public:
  ...
  using RegistryItemPtr     = std::unique_ptr<DataModelConstructor>;
...
public:
  ...
  {
    static_assert(std::is_base_of<DataModelConstructor, ModelType>::value,
