...
if(CUDNN_LIBRARY)
  ...
  set_target_properties(cudnn PROPERTIES
	...
	IMPORTED_LOCATION_DEBUG "${CUDNN_BIN_DIR}/mxnetd.dll"
  )
  ...
  set_target_properties(cudnn PROPERTIES
	...
	IMPORTED_LOCATION_RELEASE "${CUDNN_BIN_DIR}/mxnetd.dll"
  )
  ...
  set_target_properties(cudnn PROPERTIES
	...
	IMPORTED_LOCATION_RELWITHDEBINFO "${CUDNN_BIN_DIR}/mxnetd.dll"
  )
  set(CUDNN_FOUND ON)
else()
  set(CUDNN_FOUND OFF)
