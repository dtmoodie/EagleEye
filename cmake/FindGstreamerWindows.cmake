...
FIND_PATH(GSTREAMER_gst_BIN_DIR libgstreamer-1.0-0.dll
				PATHS ${GSTREAMER_DIR}/bin
				INCLUDE DOC "Directory containing libgstreamer-1.0-0.dll")
...
#FIND_LIBRARY(GSTREAMER_gstdataprotocol_LIBRARY NAMES gstdataprotocol libgstdataprotocol-1.0 gstdataprotocol-1.0
#                                               PATHS ${GSTREAMER_DIR}/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/bin ${GSTREAMER_DIR}/bin/bin C:/gstreamer/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/lib /usr/local/lib /usr/lib
#                                               ENV LIB
#                                               DOC "gstdataprotocol library to link with"
#                                               NO_SYSTEM_ENVIRONMENT_PATH)

#FIND_LIBRARY(GSTREAMER_gstinterfaces_LIBRARY NAMES gstinterfaces libgstinterfaces-1.0 gstinterfaces-1.0
#                                             PATHS ${GSTREAMER_DIR}/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/bin ${GSTREAMER_DIR}/bin/bin C:/gstreamer/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/lib /usr/local/lib /usr/lib
#                                             ENV LIB
...
#FIND_LIBRARY(GSTREAMER_gstnetbuffer_LIBRARY NAMES gstnetbuffer libgstnetbuffer-1.0 gstnetbuffer-1.0
#                                            PATHS ${GSTREAMER_DIR}/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/bin ${GSTREAMER_DIR}/bin/bin C:/gstreamer/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/lib /usr/local/lib /usr/lib
#                                            ENV LIB
...
FIND_LIBRARY(GSTREAMER_gstrtspserver_LIBRARY NAMES gstrtspserver libgstrtspserver-1.0 gstrtspserver-1.0
                                       PATHS ${GSTREAMER_DIR}/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/bin ${GSTREAMER_DIR}/bin/bin C:/gstreamer/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/lib /usr/local/lib /usr/lib
                                       ENV LIB
                                       DOC "gstrtsp library to link with"
                                       NO_SYSTEM_ENVIRONMENT_PATH)									   
