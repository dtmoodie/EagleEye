...
vtkImageViewer::vtkImageViewer() : vtkPlotterBase()
{
...
#ifdef AUTO_BUFFER
        textureObject->image_buffer = PerModuleInterface::GetInstance()
                                          ->GetSystemTable()
                                          ->GetSingleton<EagleLib::ogl_allocator>()
                                          ->get_ogl_buffer(default_texture);
#else
...
#ifdef AUTO_BUFFERS
                                              textureObject->image_buffer =
                                                  PerModuleInterface::GetInstance()
                                                      ->GetSystemTable()
                                                      ->GetSingleton<EagleLib::ogl_allocator>()
                                                      ->get_ogl_buffer(d_mat, *stream);
#else
