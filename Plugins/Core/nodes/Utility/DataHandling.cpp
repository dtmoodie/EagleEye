...
REGISTER_NODE_HIERARCHY(GetOutputImage, Image, Processing)
REGISTER_NODE_HIERARCHY(ImageInfo, Image, Processing)
REGISTER_NODE_HIERARCHY(ExportInputImage, Image, Extractor)
REGISTER_NODE_HIERARCHY(Mat2Tensor, Converter)
REGISTER_NODE_HIERARCHY(ConcatTensor, Tensor, Processing)
REGISTER_NODE_HIERARCHY(LagBuffer, Utility)
REGISTER_NODE_HIERARCHY(CameraSync, Utility)