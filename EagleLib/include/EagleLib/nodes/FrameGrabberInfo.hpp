...
{
    DEFINE_HAS_STATIC_FUNCTION(HasLoadableDocuments, T::ListLoadableDocuments, std::vector<std::string>(*)(void));
    template<class U> 
...
{
    DEFINE_HAS_STATIC_FUNCTION(HasTimeout, T::LoadTimeout, int(*)(void));
    template<class U> 
