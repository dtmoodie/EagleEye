...
namespace aqbio
{
    ...
    bool MeasureCell::processImpl()
    {
        ...
        image->copyTo(draw_image, stream.get());
        ...
        ofs << "Stddev, " << inner_radius_stats.stddev / pixel_per_um << ", "
            << outer_radius_stats.stddev / pixel_per_um << ", " << inner_diameter_stats.stddev / pixel_per_um << ", "
            << outer_diameter_stats.stddev / pixel_per_um << ", " << diff_stats.stddev / pixel_per_um << "\n";
        int count = 0;
