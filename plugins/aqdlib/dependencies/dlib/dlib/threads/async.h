...
// the following is hidden from cuda for compatibility reasons
#ifndef __CUDACC__
#include <functional>
#include <future>
...
std::future<typename std::result_of<Function(Args...)>::type> async(thread_pool& tp, Function&& f, Args&&... args)
{
